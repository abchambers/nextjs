  ...
  return (
    <main className={radarExpanded ? "app radar-expanded" : "app"}>
      ...
      <nav aria-label="Main navigation" className="navigation">
        ...
        {session && hasControlAccess && <button className={activeSection === "control" ? "active" : ""} onClick={() => setActiveSection("control")}>Control center</button>}
      </nav>
