...
function ClassroomAssignmentDesk({ assignments, selectedAssignmentId, canManage, onSelect, onCreate, message }: { assignments: ClassroomAssignment[]; selectedAssignmentId: string; canManage: boolean; onSelect: (id: string) => void; onCreate: (fields: Pick<ClassroomAssignment, "title" | "instructions" | "target_date" | "due_at" | "status">) => void; message: string }) {
  ...
  return (
    <main className={radarExpanded ? "app radar-expanded" : "app"}>
      ...
      <nav aria-label="Main navigation" className="navigation">
        ...
        {hasAcademicReviewAccess && <button className={activeSection === "control" ? "active" : ""} onClick={() => setActiveSection("control")}>{hasControlAccess ? "Control center" : activeWorkspace?.kind === "classroom" ? "Classroom" : "Review desk"}</button>}
      </nav>
      ...
      {activeSection === "control" && session && activeWorkspace?.kind === "classroom" && <section className="workspace-card"><ClassroomAssignmentDesk assignments={classroomAssignments} selectedAssignmentId={selectedClassroomAssignmentId} canManage={canManageActiveClassroom} onSelect={setSelectedClassroomAssignmentId} onCreate={createClassroomAssignment} message={assignmentMessage} /></section>}
